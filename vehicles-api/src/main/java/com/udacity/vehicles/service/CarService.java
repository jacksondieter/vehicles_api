...
public class CarService {
    ...
    public Car findById(Long id) {
        log.info("Service: Get car by id");
         ...
         */
        Car car = Optional.of(repository.findById(id)).get().orElseThrow(CarNotFoundException::new);
        /**
